...
```
Working through this hotel booking confirmation page was a fantastic way to practice complex CSS layouts, CSS transforms, and real-world JavaScript interactions.

1. Stacking and Fanning Cards with CSS Transforms
One of the key design elements of this project was the overlapping card stack. I used absolute positioning combined with CSS rotate() transforms to get the visual tilt, and smoothly animated them on hover using transition and translateX:
/* Card fan-out effect on hover */
.cards-container:hover .receipt-card {
  transform: rotate(-12deg) translateX(-30px);
}

.cards-container:hover .welcome-card {
